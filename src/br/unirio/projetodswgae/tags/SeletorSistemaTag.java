...
import br.unirio.projetodswgae.config.ControladorSistemas;

public class SeletorSistemaTag extends TagSupport
{
	...
	public int doStartTag() throws JspException
	{
		...
		try
		{
			...
			for (String sistema : ControladorSistemas.getNomesSistemas())
			{
				String selecionado = (valor.compareToIgnoreCase(sistema) == 0) ? " SELECTED" : "";
				out.write("<option value='" + sistema + "'" + selecionado + ">" + StringEscapeUtils.escapeHtml4(sistema) + "</option>\n");
			}
